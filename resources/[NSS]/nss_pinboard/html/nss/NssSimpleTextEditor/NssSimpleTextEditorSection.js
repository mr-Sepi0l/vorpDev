...
class NssSimpleTextEditorSection {
    ...
    getText() {
        ...
        /**
         * The text element is "contenteditable" so it contains <div> and <br> tags (will be added after each enter).
         * If the innerText of the element is get than the <div> and <br> tags results in multiple line breaks "\n".
         */
