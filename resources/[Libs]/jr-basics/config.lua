...
Config.Language = "French"             -- English, Dutch, German

-- Disable Default RDR2 Prompts
-- If set to false it will be disabled
Config.Prompts = {
    EatOrDrink = false, -- Eat Almonds, Pour Coffee, Take Stew Bowl etc.
    Furniture = false, -- Close/Open drawers, cabinets etc.
...
Config.Logs = {
    ...
    Webhooks = {
        JoiningLog = "https://discord.com/api/webhooks/1271507287432757298/-l08Sr4LgzDEHVGu8X1G7eqjkNigunZCaSWCGj7EwbGzCetzOG4g2cSxg5daUdWArxeR",
        LeavingLog = "https://discord.com/api/webhooks/1271507287432757298/-l08Sr4LgzDEHVGu8X1G7eqjkNigunZCaSWCGj7EwbGzCetzOG4g2cSxg5daUdWArxeR",
        JoiningModLog = "https://discord.com/api/webhooks/1271507287432757298/-l08Sr4LgzDEHVGu8X1G7eqjkNigunZCaSWCGj7EwbGzCetzOG4g2cSxg5daUdWArxeR", -- Join logs wihtout IP
        LeavingModLog = "https://discord.com/api/webhooks/1271507287432757298/-l08Sr4LgzDEHVGu8X1G7eqjkNigunZCaSWCGj7EwbGzCetzOG4g2cSxg5daUdWArxeR", -- Leave logs wihtout IP
        DeathLog = "https://discord.com/api/webhooks/1271507287432757298/-l08Sr4LgzDEHVGu8X1G7eqjkNigunZCaSWCGj7EwbGzCetzOG4g2cSxg5daUdWArxeR",
        ChatLog = "https://discord.com/api/webhooks/1271507287432757298/-l08Sr4LgzDEHVGu8X1G7eqjkNigunZCaSWCGj7EwbGzCetzOG4g2cSxg5daUdWArxeR",
    },
}
